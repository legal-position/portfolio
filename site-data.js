...
const SITE_DATA = {
  ...
  services: [
    ...
    { icon: "passport_control", title: "", text: "Представництво інтересів юридичних та фізичних осіб в державних органах, органах місцевого самоврядування, на підприємствах, установах та організаціях всіх форм власності, перед третіми особами." },
