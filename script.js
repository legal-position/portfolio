...
const SITE_DATA = {
  ...
  team: [
    { name: "Тарасенко Андрій Юрійович", role: "Керуючий партнер · судовий захист", bio: "Спеціалізується на складних судових спорах та представництві в усіх інстанціях.", photo: "" },
    { name: "Ковтун Андрій Володимирович", role: "Старший Партнер · корпоративне право", bio: "Супровід бізнесу, договірне та податкове право, due diligence.", photo: "" },
  ],
  services: [
